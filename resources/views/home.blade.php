    ...
    <body>
        ...
        <main class="l-main">
            ...
            <section class="home bd-grid" id="home">
                ...
                <div class="home__img">    
                    <img src="{{ URL::asset('img/perfil.png') }}" alt="">
            ...
            <section class="skills section" id="skills">
                ...
                <div class="skills__container bd-grid">          
                    ...
                    <div>              
                        <img src="{{ URL::asset('img/work3.png') }}" alt="" class="skills__img">
                        {{ URL::asset('img/work3.png') }}
                    </div>
                </div>
            </section>
            ...
            <section class="work section" id="work">
                ...
                <div class="work__container bd-grid">
                    <div class="work__img">
                        <img src="{{ URL::asset('img/work1.jpg') }}" alt="">
                    </div>
                    <div class="work__img">
                        <img src="{{ URL::asset('img/work2.jpg') }}" alt="">
                    </div>
                    <div class="work__img">
                        <img src="{{ URL::asset('img/work3.jpg') }}" alt="">
                    </div>
                    <div class="work__img">
                        <img src="{{ URL::asset('img/work4.jpg') }}" alt="">
                    </div>
                    <div class="work__img">
                        <img src="{{ URL::asset('img/work5.jpg') }}" alt="">
                    </div>
                    <div class="work__img">
                        <img src="{{ URL::asset('img/work6.jpg') }}" alt="">
                    </div>
                </div>
            </section>
